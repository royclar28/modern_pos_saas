 ...
 * Posición: fija en esquina inferior derecha, por encima del contenido.
 */
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
            ...
            <a
                ...
                className="relative flex items-center justify-center w-14 h-14 rounded-full shadow-xl transition-all duration-200 hover:scale-110 active:scale-95"
