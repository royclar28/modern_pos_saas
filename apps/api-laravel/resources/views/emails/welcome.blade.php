...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #7C3AED 0%, #8B5CF6 100%); padding: 50px 20px; text-align: center; }
        .header img { max-width: 150px; }
        .header h1 { color: #ffffff; margin: 0; font-size: 28px; font-weight: 800; letter-spacing: -0.025em; text-transform: uppercase; }
        .header p { color: #EDE9FE; margin-top: 10px; font-size: 16px; font-weight: 500; }
        ...
        .button { display: inline-block; padding: 16px 36px; background-color: #7C3AED; color: #ffffff !important; text-decoration: none; border-radius: 50px; font-size: 16px; font-weight: 700; box-shadow: 0 4px 10px rgba(124, 58, 237, 0.3); transition: all 0.3s ease; }
