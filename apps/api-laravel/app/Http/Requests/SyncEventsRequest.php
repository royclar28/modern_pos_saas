...
class SyncEventsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'events.*.entity_type'    => ['required', 'string', 'in:CUSTOMER,SALE,ITEM,SALE_PAYMENT,EXPENSE,SHIFT'],
            'events.*.action'         => ['required', 'string', 'in:CREATE,UPDATE,DELETE,ADJUST_STOCK,VOID,OPEN,CLOSE'],
    ...
    public function messages(): array
    {
        return [
            ...
            'events.*.entity_type.in'          => 'entity_type debe ser: CUSTOMER, SALE, ITEM, SALE_PAYMENT, EXPENSE o SHIFT.',
            'events.*.action.required'         => 'Cada evento debe especificar una action.',
            'events.*.action.in'               => 'action debe ser: CREATE, UPDATE, DELETE, ADJUST_STOCK, VOID, OPEN o CLOSE.',
